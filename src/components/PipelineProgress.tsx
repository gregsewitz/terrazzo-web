  ...
  if (compact) {
    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <span className="text-[9px]" style={{ color: 'rgba(28,26,23,0.5)', fontFamily: "'Space Mono', monospace" }}>
          ...
          return (
            ...
            >
              <span
                className="text-[9px]"
                style={{
                  color: isCompleted ? 'var(--t-verde)' : isCurrent ? 'var(--t-honey)' : 'rgba(28,26,23,0.3)',
              ...
              <span
                ...
                style={{
                  color: isCompleted ? 'var(--t-verde)' : isCurrent ? 'var(--t-honey)' : 'rgba(28,26,23,0.35)',
