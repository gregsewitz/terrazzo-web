      ...
      >
        ...
        <div className="px-5 pb-4">
          <div className="flex items-center justify-between mb-1">
            ...
            <button onClick={onClose} className="text-lg bg-transparent border-none cursor-pointer" style={{ color: 'rgba(28,26,23,0.4)' }}>
              ✕
            </button>
          </div>
        ...
        <div className="px-5 pb-4">
          ...
          <p className="text-[10px] text-center mt-2" style={{ color: 'rgba(28,26,23,0.4)' }}>
        ...
        <div className="px-5 pb-6 overflow-y-auto" style={{ maxHeight: '35vh' }}>
          <p className="text-[10px] font-bold uppercase tracking-wider mb-2" style={{ color: 'rgba(28,26,23,0.4)', fontFamily: "'Space Mono', monospace" }}>
