    ...
    >
      <div style={{ pointerEvents: 'auto' }} className="flex flex-col gap-2">
          ...
          <div className="relative" ref={pickerRef}>
            ...
            {!selectedCollection ? (
              <button
                ...
                style={{
                  background: pickerOpen ? INK['10'] : INK['06'],
                  color: INK['50'],
                }}
              >
            ...
            {pickerOpen && (
              ...
              >
                ...
                <div className="flex items-center justify-between px-3 pt-3 pb-2">
                  <span className="text-[11px] font-semibold" style={{ color: INK['60'], fontFamily: FONT.sans }}>
                    Add to collection
                  </span>
                ...
                <div className="max-h-[200px] overflow-y-auto px-1.5 pb-1.5" style={{ scrollbarWidth: 'thin' }}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-[11px] font-medium truncate" style={{ color: 'var(--t-ink)' }}>
                            {col.name}
                          </div>
                          <div className="text-[9px]" style={{ color: INK['40'] }}>
                  ...
                  {collections.length === 0 && !createMode && (
                    <div className="px-2 py-3 text-center">
                      <span className="text-[10px]" style={{ color: INK['40'] }}>No collections yet</span>
                    </div>
                  )}
                </div>
                ...
                <div style={{ borderTop: `1px solid var(--t-linen)` }}>
                  {!createMode ? (
                    <button
                      ...
                      style={{ background: 'transparent', color: 'var(--t-honey)' }}
                    ...
                    <div className="flex items-center gap-1.5 px-3 py-2">
                      ...
                      <button
                        ...
                        style={{
                          background: newName.trim() ? 'var(--t-honey)' : INK['10'],
                          color: newName.trim() ? 'white' : INK['40'],
                        }}
                      >
        ...
        <button
          ...
          style={{
            background: hasSelection ? 'var(--t-ink)' : INK['10'],
            color: hasSelection ? 'white' : INK['40'],
        ...
        >
          {importing ? (
            ...
            <>
              {label}
              <PerriandIcon name="terrazzo" size={16} color={hasSelection ? 'white' : INK['40']} />
            </>
          )}
        </button>
        ...
        {!hasSelection && (
          <p className="text-center text-[10px] mt-0.5" style={{ color: INK['40'] }}>
