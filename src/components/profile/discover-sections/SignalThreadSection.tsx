              ...
              >
                ...
                <div className="flex-1 pb-4">
                  ...
                  <div className="flex items-baseline gap-2 mb-1">
                    ...
                    {place.matchTier && (
                      <span className="text-[12px] font-semibold ml-auto px-1.5 py-0.5 rounded-full" style={{ color: getMatchTierByLabel(place.matchTier).color, background: getMatchTierByLabel(place.matchTier).bg, fontFamily: FONT.mono }}>{getMatchTierByLabel(place.matchTier).shortLabel}</span>
                    )}
                  </div>
