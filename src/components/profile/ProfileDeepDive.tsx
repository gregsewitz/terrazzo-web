            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {signals.length > 5 && (
                  <span
                    className="text-[10px] px-2 py-1 rounded-full"
                    style={{ background: 'rgba(28,26,23,0.04)', color: 'rgba(28,26,23,0.4)' }}
                  >
                    +{signals.length - 5}
                  </span>
                )}
        ...
        {profile.contextModifiers.map((mod, i) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-[10px] leading-relaxed" style={{ color: 'rgba(28,26,23,0.55)' }}>
                {mod.shifts}
              </p>
            </div>
          );
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] mb-2" style={{ color: 'rgba(28,26,23,0.5)' }}>
                  {prop.location}
                </div>
