...
function HeroSection({ profile, signalCount }: { profile: typeof TASTE_PROFILE; signalCount: number }) {
  const name = profile?.overallArchetype ? profile.overallArchetype.split(' ').pop() : 'there';
  return (
    <div className="px-5 pt-4 pb-5">
      ...
      >
        Based on {signalCount} signals across 6 dimensions
      </p>
    </div>
  );
}
      ...
      <div>
        <div className="flex items-center gap-2 mb-4">
          ...
          <span
            ...
            style={{ background: `${domainColor}40`, color: domainColor, fontFamily: FONT.mono }}
          >
            {card.signalDomain}
          </span>
        </div>
        <p className="text-[13px] leading-relaxed mb-1" style={{ color: 'rgba(245,245,240,0.7)', fontFamily: FONT.sans }}>
          Because you love
        </p>
        <p
...
function ContradictionSection({ profile }: { profile: typeof TASTE_PROFILE }) {
    ...
    <div className="px-5 mb-6">
      ...
      >
        <div className="flex gap-4 mb-4">
          <div className="flex-1">
            <div
              ...
              style={{ color: 'rgba(245,245,240,0.55)', fontFamily: FONT.mono }}
            >
              You said
            </div>
          ...
          <div className="flex items-center" style={{ color: 'rgba(245,245,240,0.35)', fontFamily: FONT.serif, fontSize: 16 }}>
            vs
          </div>
          <div className="flex-1">
            <div
        ...
        >
          <div
            className="text-[9px] uppercase tracking-wider mb-1.5"
            style={{ color: 'rgba(245,245,240,0.6)', fontFamily: FONT.mono }}
          >
  ...
  return (
    <div className="mb-6 px-5">
      ...
      <div className="mb-3">
        ...
        <p className="text-[11px]" style={{ color: INK['95'], fontFamily: FONT.mono }}>
          {collection.subtitle}
        </p>
      </div>
      <div
      ...
      <div className="p-4 flex flex-col">
        <div className="flex items-start justify-between mb-2">
          <div>
            ...
            <div className="text-[11px]" style={{ color: INK['95'] }}>{place.location}</div>
          </div>
        ...
        <div className="flex flex-wrap gap-1 mb-2.5">
          {place.signals.map(s => (
            <span
              ...
              style={{ background: `${domainColor}12`, color: domainColor, fontFamily: FONT.sans }}
            >
              {s}
            </span>
          ))}
      ...
      >
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div>
            ...
            <div className="text-[11px]" style={{ color: INK['95'] }}>{s.location}</div>
            <div className="flex gap-2 mt-1.5">
              <span className="text-[9px] px-2 py-0.5 rounded-full" style={{ background: 'rgba(74,107,139,0.1)', color: '#4a6b8b', fontFamily: FONT.mono }}>
                {s.strongAxis} {s.strongScore}%
              </span>
              <span className="text-[9px] px-2 py-0.5 rounded-full" style={{ background: 'rgba(107,107,74,0.1)', color: '#6b6b4a', fontFamily: FONT.mono }}>
        ...
        <p className="text-[10px] italic leading-relaxed mt-2.5" style={{ color: INK['90'] }}>
          {s.tension}
        </p>
      </div>
    </div>
  ...
  return (
    <div className="px-5 mb-6">
      ...
      >
        ...
        <p className="text-[11px] mb-4" style={{ color: INK['95'], fontFamily: FONT.mono }}>
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-baseline gap-1.5">
          ...
          <span className="text-[10px]" style={{ color: INK['90'] }}>{rec.location}</span>
        </div>
        <p className="text-[10px] leading-snug" style={{ color: INK['95'] }}>
          {rec.whyFits}
        </p>
      </div>
    </div>
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: `${save.color}15`, color: save.color, fontFamily: FONT.mono }}
      >
        {save.friendInitial}
      </div>
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5 mb-0.5">
          ...
          <span className="text-[11px]" style={{ color: INK['90'] }}>saved</span>
          <span className="text-[11px] font-semibold" style={{ color: 'var(--t-ink)' }}>
            {save.place}
          </span>
        </div>
        <div className="text-[10px] mb-1" style={{ color: INK['90'] }}>
          {save.location} · {save.type}
        </div>
        <div className="flex items-center gap-2">
          <span
            className="text-[10px] font-bold"
            style={{ color: save.color, fontFamily: FONT.mono }}
          >
            {save.score}% match
          </span>
