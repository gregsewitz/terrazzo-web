...

{
    ...
    "places": [
      {
        ...
        "matchTier": "Strong match or Good match"
      }
    ]
  },
  "tasteTension": {
  ...
  "stretchPick": {
    "name": "Place name",
    "location": "City, Country",
    "matchTier": "Worth a look or Mixed fit",
    "type": "hotel | restaurant | cafe | bar",
    "strongAxis": "Axis name",
    "strongTier": "Strong match or Good match",
    "weakAxis": "Axis name",
    "weakTier": "Mixed fit or Not for you",
