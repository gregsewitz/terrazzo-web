...
export const MOSAIC_SECTIONS: Record<string, { label: string; emoji: string; color: string }> = {
  ...
  Service:      { label: 'Service & Ritual',     emoji: '◻', color: COLOR.ochre },
  Geography:    { label: 'Location & Geography',    emoji: '◆', color: COLOR.darkTeal },
  Character:    { label: 'Character',            emoji: '◇', color: COLOR.periwinkle },
  Mood:         { label: 'Mood & Energy',        emoji: '●', color: COLOR.lightYellow },
  Scenario:     { label: 'Scenarios',            emoji: '○', color: COLOR.warmGray },
  Identity:     { label: 'Identity',             emoji: '▲', color: COLOR.navy },
  Restaurant:   { label: 'Restaurants',          emoji: '▽', color: COLOR.coral },
  Bar:          { label: 'Bars & Drink',         emoji: '■', color: COLOR.coral },
  Activity:     { label: 'Activities',           emoji: '□', color: COLOR.olive },
  Shopping:     { label: 'Shopping',             emoji: '▼', color: COLOR.peach },
  Neighborhood: { label: 'Neighborhoods',        emoji: '△', color: COLOR.teal },
  CrossDomain:  { label: 'Cross-Domain',         emoji: '◈', color: COLOR.warmGray },
};
